...
# 输出路径：
#   - 单条：终端实时输出
#   - 批量：默认 /tmp/xuanyu11/image_test_output/image_batch_<时间戳>.tsv 和 .json
...
# 默认输出到 /tmp/xuanyu11，避免跨 Linux 用户权限问题
DEFAULT_OUTPUT_DIR="/tmp/xuanyu11/image_test_output"
TMP_DIR="/tmp/xuanyu11/image_test_$$"
